				...
				<fieldset class="appearance section">
					...
					<?php if ( current_theme_supports( 'bpfb_interface_style' ) || current_theme_supports( 'bpfb_toolbar_icons' ) ) { ?>
						<div class="updated below-h2">
							<p><?php esc_html_e( 'Dein BuddyPress-Design enthält Überschreibungen im PS Activity-Stil. Respektiere die Auswahl, die Du in der &quot;Aussehen&quot; Sektion für Dein Theme getroffen hast.', 'ps-activity-plus' ); ?></p>
						</div>
					<?php } ?>
				...
				<fieldset class="functional section">
					...
					<fieldset class="thumbnail option">
						...
						<label for="bpfb-thumbnail_size-height">
							<?php esc_html_e( 'Höhe', 'ps-activity-plus' ) ?>
